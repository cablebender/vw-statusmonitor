...
#
# Verwaltung der automatischen Aktionen.
#
...
def perform_checks(config):
    ...
    for check in config.get(
        ...
        #
        # Automatische Aktion auswerten.
        #
        try:
            action_manager.process_result(
                check,
                result
            )
